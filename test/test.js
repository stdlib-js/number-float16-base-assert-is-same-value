...
tape( 'the function returns `true` if provided two half-precision floating-point numbers which are the same value', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns `false` if not provided two half-precision floating-point numbers which are the same value', function test( t ) {
	var a;
	var b;
	var i;
